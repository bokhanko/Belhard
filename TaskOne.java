...
public class TaskOne {
	public static void main(String[] args) {
		...
		System.out.println("C)" + day + " full day/s and " + hour + " full hour/s and " + min + " full minutes and "
				+ secRest + " seconds. ");
		System.out.println("D)" + week + " full week/s " + day + " full day/s " + hour + " full hour/s and " + min
